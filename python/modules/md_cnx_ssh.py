...
# /usr/bin/sshpass -p "PASSWORD" ssh-copy-id -o StrictHostKeyChecking=no -i ~/.ssh/id_rsa.pub root@IPSOURCE
...
#    print("ERR",ssh_stderr.read())
    ...
    print("Retour md STDIN:",ssh_stdin,"\nRetour md STDOUT:", ssh_stdout,"\nRetour md STDERR:", ssh_stderr)
    ssh.close()
    return returnvalue
